...
using SharpGenTools.Sdk.Tasks;

namespace SharpGenTools.Sdk.Extensibility
{
    internal class ExtensibilityDriver
    {
        private readonly HashSet<ExtensionReference> extensionReferences = new HashSet<ExtensionReference>();
        private ImmutableHashSet<ExtensionReference>? extensionsImmutable;

        public static ExtensibilityDriver Instance { get; } = new ExtensibilityDriver();
