...
namespace SharpGen.Parser
{
    public class CppHeaderGenerator
    {
        ...
        public Result GenerateCppHeaders(ConfigFile configRoot, IReadOnlyCollection<ConfigFile> configsWithIncludes, ISet<ConfigFile> configsWithExtensionHeaders)
        {
        ...
        private static string GenerateIncludeConfigContents(ConfigFile configRoot, ConfigFile configFile,
                                                            ...
                                                            ICollection<ConfigFile> configsWithExtensionHeaders,
                                                            string prolog)
        {
