...
namespace SharpGen.Extension.MicrosoftDocs.XmlDoc.CodeSnippet
{
    public class HtmlCodeSnippetRenderer : XmlDocObjectRenderer<CodeSnippet>
    {
        ...
        protected override void Write(XmlDocRenderer renderer, CodeSnippet codeSnippet)
        {
        ...
        public string GetContent(string content, CodeSnippet obj)
        {
            ...
            if (!string.IsNullOrEmpty(obj.TagName))
            {
                ...
                {
                    _context.LogWarning(
                        "unsupported-sharpgen",
                        "Notebooks not supported in SharpGen.Extension.MicrosoftDocs",
                        obj);
                    return string.Empty;
                }
