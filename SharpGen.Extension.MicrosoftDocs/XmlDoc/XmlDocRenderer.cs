...
using SharpGen.Extension.MicrosoftDocs.XmlDoc.Inlines;
...
namespace SharpGen.Extension.MicrosoftDocs.XmlDoc
{
    ...
    public class XmlDocRenderer : TextRendererBase<XmlDocRenderer>
    {
        ...
        public XmlDocRenderer(TextWriter writer) : base(writer)
        {
            ...
            ObjectRenderers.Add(new XmlDocBlockRenderer());
            ...
            ObjectRenderers.Add(new XmlDocInlineRenderer());
            ObjectRenderers.Add(new XmlDocEntityInlineRenderer());
        ...
        public XmlDocRenderer WriteEscape(string content)
        {
        ...
        /// <param name="softEscape">Only escape &lt; and &amp;</param>
        /// <returns>This instance</returns>
        public XmlDocRenderer WriteEscape(string content, int offset, int length, bool softEscape = false)
        {
        ...
        /// <param name="content">The content.</param>
        /// <returns>This instance</returns>
        public XmlDocRenderer WriteEscapeUrl(string content)
        {
            if (content == null)
                return this;
        ...
        public void WriteLeafRawLines(LeafBlock leafBlock, bool writeEndOfLines, bool escape, bool softEscape = false)
        {
            ...
            if (leafBlock.Lines.Lines == null) return;
