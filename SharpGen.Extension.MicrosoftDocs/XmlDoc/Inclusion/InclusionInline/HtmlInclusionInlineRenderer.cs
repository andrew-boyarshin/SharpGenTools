...
{
    public class HtmlInclusionInlineRenderer : XmlDocObjectRenderer<InclusionInline>
    {
        ...
        protected override void Write(XmlDocRenderer renderer, InclusionInline inclusion)
        {
