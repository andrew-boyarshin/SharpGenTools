...
using SharpGen.Extension.MicrosoftDocs.XmlDoc.Inclusion.InclusionBlock;
using SharpGen.Extension.MicrosoftDocs.XmlDoc.Inclusion.InclusionInline;

namespace SharpGen.Extension.MicrosoftDocs.XmlDoc.Inclusion
{
    /// <summary>
