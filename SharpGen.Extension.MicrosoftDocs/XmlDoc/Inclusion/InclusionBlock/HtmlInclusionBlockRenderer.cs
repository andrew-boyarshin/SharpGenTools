...
namespace SharpGen.Extension.MicrosoftDocs.XmlDoc.Inclusion.InclusionBlock
{
    public class HtmlInclusionBlockRenderer : XmlDocObjectRenderer<InclusionBlock>
    {
        ...
        protected override void Write(XmlDocRenderer renderer, InclusionBlock inclusion)
        {
